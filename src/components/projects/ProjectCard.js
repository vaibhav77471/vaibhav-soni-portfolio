...
export default function ProjectCard({ project }) {
  return (
    <motion.div whileHover={{ y: -10, scale: 1.03 }} transition={{ duration: 0.35 }} className="w-full h-full" >
      <div className=" h-full flex flex-col rounded-[28px] overflow-hidden bg-[#000000] border border-[#fff]/10 shadow-[0_10px_40px_rgba(0,0,0,0.6)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.8)] transition-all duration-500 group " >
        ...
        <div className="flex flex-col flex-1 px-[28px] py-[26px]">
          ...
          {/* Title */}
          <h3 className=" text-[22px] md:text-[26px] font-semibold text-[#fff] mb-[10px] tracking-[-0.3px] ">
            {project.title}
          </h3>

          {/* Description */}
          <p className=" text-[15px] text-[#fff]/70 leading-[1.7] mb-[20px] flex-1 ">
            {project.description}
          </p>
          ...
          <div className="flex items-center gap-[12px] mt-auto">
            ...
            <a
              ...
              className=" px-[14px] py-[6px] rounded-full border border-[#fff]/20 text-[13px] text-[#fff]/80 backdrop-blur-md hover:bg-lime-400 hover:text-black transition "
            >
              View →
            </a>
